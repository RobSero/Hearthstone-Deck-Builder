      ...
      <div className='page-container'>
        ...
        <div className='left-view' style={{ width: mouseXposition }}>
          <div className='character-flex'>
            ...
            <img id='char2' className='characters animate__bounceInUp animate__animated'src='https://res.cloudinary.com/dy7eycl8m/image/upload/v1600627927/pngwave_56_xx0k3i.png' alt='hearthstone character' />
